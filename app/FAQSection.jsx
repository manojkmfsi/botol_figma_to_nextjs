...
export default function FAQSection() {
  ...
  return (
    <section className="w-full mt-[40px] sm:mt-[60px] lg:mt-[80px] bg-gray-200">
      <div className="w-full py-[40px] sm:py-[60px] lg:py-[80px]">
        <div className="w-full max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 rounded-md sm:rounded-lg lg:rounded-[18px] ">
                ...
                className={`w-full bg-white ${
                  index === 0
                    ...
                    : index === faqItems?.length - 1
                      ...
                      : ""
                } ${index < faqItems?.length - 1 ? "border-b-4 border-solid border-light" : ""}`}
              >
                <div className="px-[30px] sm:px-[45px] lg:px-[60px] py-[23px] sm:py-[34px] lg:py-[46px]">
                  ...
                  {expandedItem === index && item?.answer && (
                    <div className="mt-[15px] sm:mt-[22px] lg:mt-[30px] ml-[50px] sm:ml-[75px] lg:ml-[120px]">
